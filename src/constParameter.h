...
const int cScrollUITitleFontSize = cScrollUIWidth * 0.15f;
const int cScrollUIContextFontSize = cScrollUITitleFontSize * 0.8f;
const int cScrollUITitleFontENSize = cScrollUIWidth * 0.1f;
const int cScrollUIContextFontENSize = cScrollUITitleFontENSize * 0.8f;

const float cScrollUIAnimDuration = 0.3f;

//Close UI
const int cCloseUIBGSize = cSelectWidth * 0.1;
const int cCloseUISize = cCloseUIBGSize * 0.8f;
const ofColor cCloseUIBGColor = cSelectCoverColor;
